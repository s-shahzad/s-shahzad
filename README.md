...
**Detection Engineer · IEEE First-Author · NIDS Researcher**
...
[Secure-by-design IoT architectures with ML-enhanced intrusion detection](https://doi.org/10.1109/GCAIoT68269.2025.11275540)

**Universal NIDS** — Hybrid multi-engine intrusion detection system

| Metric | Result |
|---|---|
| Flows analyzed | 87,432 |
| Runtime | 6 hr continuous |
| False positives | 0 |
| Validated replay (509 flows) | 10 alerts · 1.96% alert ratio · 100% reproducible |
| Detection engines | Signature · Supervised ML · Unsupervised ML · Weighted fusion |

Detection content published as Sigma, SPL, Suricata rules, and Zeek scripts.
...
![Snort](https://img.shields.io/badge/Snort-C30017?style=flat-square&logoColor=white)
...
![SIEM](https://img.shields.io/badge/SIEM-1A1A2E?style=flat-square&logoColor=white)
